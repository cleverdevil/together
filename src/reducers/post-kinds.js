...
const postKinds = [
  ...
  },
  {
    ...
    icon: NoteIcon,
    selected: false,
    filter: (post) => (post.properties.content && !post.properties.name),
  },
  {
    id: 'photo',
    name: 'Photos',
    icon: PhotoIcon,
    selected: false,
    filter: (post) => (post.properties.photo),
  },
  {
    id: 'post',
    name: 'Articles',
    icon: ArticleIcon,
    selected: false,
    filter: (post) => (post.properties.name && post.properties.content),
  },
  {
    id: 'audio',
    name: 'Podcasts & Music',
    icon: AudioIcon,
    selected: false,
    filter: (post) => (post.properties.audio),
  },
  {
    id: 'checkins',
    name: 'Checkins',
    icon: CheckinIcon,
    selected: false,
    filter: (post) => (post.properties.location),
  },
];
